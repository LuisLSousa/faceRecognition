...
class SignIn extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://enigmatic-bayou-45047.herokuapp.com/signin', {
            method: 'post',
    ...
    render(){
        ...
        return(
            <article className="form br3 ba b--black-10 mv4 w-100 w-auto-m w-25-l mw6 shadow-5 center">
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <input
                            ...
                            className="b ph3 pv2 input-reset ba bg-transparent white bg-transparent grow pointer f6 dib"
                            type="submit"
                            value="Sign in"/>
                        </div>
